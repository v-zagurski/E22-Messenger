# -*- coding: utf-8 -*-
"""
Created on Mon Dec 22 14:17:31 2025
...
class Ui_LoraWindow(object):
    def setupUi(self, LoraWindow):
        if not LoraWindow.objectName():
            LoraWindow.setObjectName(u"LoraWindow")
        LoraWindow.resize(1150, 450)
        self.centralwidget = QWidget(LoraWindow)
        ...
        LoraWindow.setCentralWidget(self.centralwidget)

        self.retranslateUi(LoraWindow)
    # setupUi

    def retranslateUi(self, LoraWindow):
        LoraWindow.setWindowTitle(QCoreApplication.translate("LoraWindow", u"MainWindow", None))
        self.gr_con.setTitle(QCoreApplication.translate("LoraWindow", u"\u041f\u043e\u0434\u043a\u043b\u044e\u0447\u0435\u043d\u0438\u0435", None))
        self.label.setText(QCoreApplication.translate("LoraWindow", u"\u041d\u043e\u043c\u0435\u0440 \u043f\u043e\u0440\u0442\u0430", None))
        self.b_refr.setText(QCoreApplication.translate("LoraWindow", u"\u041e\u0431\u043d\u043e\u0432\u0438\u0442\u044c", None))
        self.b_connect.setText(QCoreApplication.translate("LoraWindow", u"\u041f\u043e\u0434\u043a\u043b\u044e\u0447\u0438\u0442\u044c", None))
        self.gr_set.setTitle(QCoreApplication.translate("LoraWindow", u"\u041d\u0430\u0441\u0442\u0440\u043e\u0439\u043a\u0438", None))
        self.cmb_pow.setItemText(0, QCoreApplication.translate("LoraWindow", u"22", None))
        self.cmb_pow.setItemText(1, QCoreApplication.translate("LoraWindow", u"17", None))
        self.cmb_pow.setItemText(2, QCoreApplication.translate("LoraWindow", u"13", None))
        self.cmb_pow.setItemText(3, QCoreApplication.translate("LoraWindow", u"10", None))

        self.label_26.setText(QCoreApplication.translate("LoraWindow", u"\u041a\u0430\u043d\u0430\u043b", None))
        self.b_edit.setText(QCoreApplication.translate("LoraWindow", u"\u041f\u0440\u0438\u043c\u0435\u043d\u0438\u0442\u044c", None))
        self.label_24.setText(QCoreApplication.translate("LoraWindow", u"\u041c\u043e\u0449\u043d\u043e\u0441\u0442\u044c", None))
        self.label_25.setText(QCoreApplication.translate("LoraWindow", u"\u0434\u0411\u043c", None))
        self.label_27.setText(QCoreApplication.translate("LoraWindow", u"ID \u0441\u0435\u0442\u0438", None))
        self.b_reset.setText(QCoreApplication.translate("LoraWindow", u"\u041e\u0447\u0438\u0441\u0442\u0438\u0442\u044c \u0431\u0443\u0444\u0435\u0440", None))
        self.gr_tx.setTitle(QCoreApplication.translate("LoraWindow", u"\u041f\u0435\u0440\u0435\u0434\u0430\u0447\u0430", None))
        self.b_message.setText(QCoreApplication.translate("LoraWindow", u"\u041e\u0442\u043f\u0440\u0430\u0432\u0438\u0442\u044c \u0441\u043e\u043e\u0431\u0449\u0435\u043d\u0438\u0435", None))
        self.txt_tx.setDocumentTitle("")
        self.b_file.setText(QCoreApplication.translate("LoraWindow", u"\u041e\u0442\u043f\u0440\u0430\u0432\u0438\u0442\u044c \u0444\u0430\u0439\u043b", None))
        self.b_ping.setText(QCoreApplication.translate("LoraWindow", u"\u0420\u0435\u0436\u0438\u043c ping", None))
        self.gr_rx.setTitle(QCoreApplication.translate("LoraWindow", u"\u0421\u043e\u043e\u0431\u0449\u0435\u043d\u0438\u044f", None))
        self.b_clear.setText(QCoreApplication.translate("LoraWindow", u"\u041e\u0447\u0438\u0441\u0442\u0438\u0442\u044c \u0438\u0441\u0442\u043e\u0440\u0438\u044e", None))
        self.gr_control.setTitle(QCoreApplication.translate("LoraWindow", u"\u041a\u043e\u043d\u0442\u0440\u043e\u043b\u044c \u043f\u0440\u0438\u0435\u043c\u0430", None))
    # retranslateUi
